...
const Header = () => {
    ...
    return (
        <div className="instrument">
            <div
                className={`fixed top-0 hidden lg:flex left-0 w-full h-auto duration-1000  z-[99] 2xl:py-[20px] xl:py-[0px] px-[3vw] transition-all  ${scrolled ? 'bg-[#fff] py-[0px] shadow-md top-0 h-[80px] items-center  transition-all duration-1000 ' : 'bg-transparent  transition-all  duration-1000    '}`}
            >
