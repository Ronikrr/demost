...
const Whychoose = () => {
    return (
        <section className="banner relative  py-[50px] h-full md:h-[200vh] xl:h-[175vh] 2xl:h-[200vh] lg:py-[100px] w-full ">
            ...
            <div className="container mx-auto">
                ...
                {/* First Section */}
                <div className="flex flex-col relative  pb-[95px] lg:pb-0 xl:absolute xl:left-32 4xl:top-[200px] 4xl:left-[100px] justify-center w-full mx-auto text-center md:w-[436px] h-full lg:h-[506px] head">
                    <img src={boy_3} className=" xl:w-[300px] xl:h-[365px] 4xl:w-[436px] 4xl:h-[506px]" alt="" />
                </div>
                <div className="relative my-10 lg:my-0 flex items-center w-full poppins_thin justify-center lg:pt-[95px]  flex-col sm:flex-row">
                    <div className="flex flex-col relative right-0 xl:absolute xl:top-[57px] xl:left-[500px] justify-center w-full text-center xl:w-[550px] 2xl:w-[754px] head">
                ...
                <div className="relative my-10 lg:my-0 flex items-center w-full poppins_thin justify-center lg:pt-[95px]  flex-col sm:flex-row">
                    <div className="flex flex-col relative right-0 xl:absolute xl:top-[457px] xl:right-0 2xl:right-[-3%] justify-center w-full text-center xl:w-[550px] 2xl:w-[754px] head">
                        <img src={plus} className="hidden lg:block xl:w-[180px] xl:h-[180px]  2xl:left-0 2xl:w-[306px] sm:w-[106px]  2xl:h-[306px] sm:h-[206px] left-[-40%] lg:left-0 absolute" alt="" />
                        <h1 className="text-[18px] sm:text-[24px]">✅ Expert Digital Marketers</h1>
                        <div className="mx-auto w-full md:w-[400px] relative xl:mt-[75px] 2xl:mt-[150px]">
                            <p className="text-[14px] sm:text-[18px] poppins_thin text-black">Skilled professionals crafting winning <br /> marketing strategies</p>
                ...
                <div className="relative my-10 lg:my-0 flex items-center w-full poppins_thin justify-center lg:pt-[95px]  flex-col sm:flex-row">
                    <div className="flex flex-col relative right-0 xl:absolute xl:top-[525px] xl:left-0 2xl:left-[3%] justify-center w-full text-center xl:w-[550px] 2xl:w-[754px] head">
                        <img src={plus} className="hidden lg:block xl:w-[180px] xl:h-[180px]  2xl:left-0 2xl:w-[306px] sm:w-[106px]  2xl:h-[306px] sm:h-[206px] left-[-40%] lg:left-0 absolute" alt="" />
                        <h1 className="text-[18px] sm:text-[24px]">✅ Expert Digital Marketers</h1>
                        <div className="mx-auto w-full md:w-[400px] relative xl:mt-[75px] 2xl:mt-[150px]">
                            <p className="text-[14px] sm:text-[18px] poppins_thin text-black">Skilled professionals crafting winning <br /> marketing strategies</p>
                ...
                <div className="relative my-10 lg:my-0 flex items-center w-full poppins_thin justify-center lg:pt-[95px]  flex-col sm:flex-row">
                    <div className="flex flex-col relative right-0 xl:absolute xl:top-[800px] xl:left-[500px] justify-center w-full text-center xl:w-[550px] 2xl:w-[754px] head">
                        <img src={plus} className="hidden lg:block xl:w-[180px] xl:h-[180px]  2xl:left-0 2xl:w-[306px] sm:w-[106px]  2xl:h-[306px] sm:h-[206px] left-[-40%] lg:left-0 absolute" alt="" />
                        <h1 className="text-[18px] sm:text-[24px]">✅ Expert Digital Marketers</h1>
                        <div className="mx-auto w-full md:w-[400px] relative xl:mt-[75px] 2xl:mt-[150px]">
                            <p className="text-[14px] sm:text-[18px] poppins_thin text-black">Skilled professionals crafting winning <br /> marketing strategies</p>
