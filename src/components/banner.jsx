...
//               <img src={boy2} className='w-full h-full' alt="" />
//           </div>
...
//                   <h1 className="relative text-[60px] lg:text-[300px] w-full lg:w-[1016px]  uppercase flex flex-wrap  " >
//                       <div className=" cursor-pointer relative h-full   w-[301.9px] 2xl:h-[328.18px] group flex items-center justify-end ">
//                           <img src={vector_1} className='w-full h-full' alt="" />
//                           <div className="absolute w-[60px] md:w-[270px] duration-1000 h-[25px] md:h-[63px] shadow-xl bg-white group-hover:opacity-100  opacity-0 rotate-[15.32deg] bottom-[36px] left-[4px] rounded-xl text-[15px] md:text-[50px] capitalize  text-center font-bold geostar_regular ">boost</div>
//                       </div>
//                       <div className="cursor-pointer w-[327.56px] relative mt-[-70px]  h-full 2xl:h-[354.96px] group  flex items-end justify-center">
//                           <img src={vector_2} className='w-full h-full ' alt="" />
//                           <div className="absolute w-[60px] md:w-[270px] duration-1000 h-[25px] md:h-[63px] shadow-xl rounded-[10px] bg-white group-hover:opacity-100  opacity-0 rotate-[-28deg] top-[50px] left-[20px] text-[15px] md:text-[50px] capitalize text-center geostar_regular "><p>build</p></div>
//                       </div>
//                       <div className="cursor-pointer ml-[10px] w-[351.25px] mt-1  relative h-full 2xl:h-[319.12px] group  flex items-center justify-start">
//                           <img src={vector_3} className='w-full h-full' alt="" />
//                           <div className="absolute w-[60px] md:w-[346px] duration-1000 h-[25px] md:h-[63px] shadow-xl rounded-[10px] bg-white group-hover:opacity-100  opacity-0 rotate-[-7.47deg] bottom-[0px] left-[0px] text-[15px] md:text-[50px] capitalize text-center geostar_regular font-semibold text-black ">dominate</div>
//                       </div>
...
//               <h1 className='text-[80px] text-center 2xl:text-[150px] 4xl:text-[180px] leading-none capitalize' ><span className='text-[#ef4523]' >delivers</span> results!"</h1>
//           </div>

//           <div className="absolute hidden md:block top-[623px] w-[185px] h-[457px] right-[46px]">
//               <img src={boy1} className='w-full h-full' alt="" />
