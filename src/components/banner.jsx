...
const Banner = () => {
  ...
  return (
      <section
          ...
          <div className="absolute hidden md:block w-[15%] bottom-[-32px] left-[50px]">
              <img src={boy2} className='w-[70%]' alt="" />
          </div>
          <div className="absolute hidden md:block top-[190px] w-[20%]  left-[70px]">
          ...
          <div className="container px-[15px] mx-auto 2xl:w-[1320px]">
              <div className="relative flex items-center justify-center w-9/12 mx-auto title ">
                  <h1 className="relative text-[60px] lg:text-[300px] w-full lg:w-10/12  uppercase flex flex-wrap gap-10 xl:gap-[100px]" >
                      <div className="rotate-[-15deg] cursor-pointer relative h-full 2xl:h-[350px] group "> b
                          <div className="absolute w-[60px] md:w-[200px] duration-1000 h-[25px] md:h-[50px] shadow-xl bg-white group-hover:opacity-100  opacity-0 rotate-[30deg] bottom-[12px] left-[-80px] rounded-xl text-[15px] md:text-[30px] capitalize  text-center ">boost</div>
                      </div>
                      <div className="rotate-[15deg] cursor-pointer  relative h-full 2xl:h-[350px] group">  b
                          <div className="absolute w-[60px] md:w-[200px] duration-1000 h-[25px] md:h-[50px] shadow-xl bg-white group-hover:opacity-100  opacity-0 rotate-[-50deg] top-[75px] left-[-75px] text-[15px] md:text-[30px] capitalize text-center "><p>build</p></div>
                      </div>
                      <div className="rotate-[-5deg] cursor-pointer text-[#ef4523] relative h-full 2xl:h-[350px] group">  d
                          <div className="absolute w-[60px] md:w-[200px] duration-1000 h-[25px] md:h-[50px] shadow-xl bg-white group-hover:opacity-100  opacity-0 rotate-[-5deg] bottom-[-12px] left-[0px] text-[15px] md:text-[30px] capitalize text-center ">dominate</div>
                      </div>
                  </h1>
          ...
          <div className="absolute hidden md:block bottom-[-190px] right-[-50px]">
