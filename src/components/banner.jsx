...
const Banner = () => {
  return (
      <section
          className="banner relative pt-[200px] min-h-screen bg-[url('https://uithemez.com/i/artech/home6_modernAgency/assets/img/boxes.png')] bg-cover bg-center">
          <div className="container px-[15px] mx-auto 2xl:w-[1320px]">
              <div className="title relative ">
                  <h1 className="relative text-[200px] uppercase flex flex-wrap" >
                      <div className=""> Modern </div>
                      <div className="ms-auto">  Agency  </div>
                  </h1>
                  <img src="https://uithemez.com/i/artech/home6_modernAgency/assets/img/ltr_a.png" className='absolute top-[-6%] right-[3%]' alt="" />
                  <div className="absolute w-[220px] h-[220px] block z-[20] mt-[-30px] left-[5%] bottom-0">
              ...
              <div className="content mt-[50px] ">
                  <div className="flex flex-wrap  ">
                      ...
                      <div className="w-3/12 ml-[8.3%] px-[15px]">
                          <div className="info mt-5 lg:mt-0">
                      ...
                      <div className="w-4/12 px-[15px]">
                          <div className="mt-[-140px] h-[250px]">
