...
const Aboutsectoion = () => {
    return (
        <section
            className="banner relative pt-[100px] lg:pb-[100px]   ">
            <div className="container mx-auto">
                <div className="flex flex-col justify-center text-center head">
                    ...
                    <p className='font-medium text-[20px] instrument' >BBD (BadeBazarkaDigital) offers cutting-edge digital marketing and social media optimization solutions to drive your business growth.</p>
                </div>
